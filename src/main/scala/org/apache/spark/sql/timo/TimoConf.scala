...
private[timo] object TimoConf {
  ...
  val Topk: TimoConfEntry[String] =stringConf("timo.topk",defaultValue = Some("Slot"))

  val INDEX_PARTITIONS: TimoConfEntry[Int] = intConf("timo.index.partitions", defaultValue = Some(4))

  // Partitioner Parameter
  val PARTITION_METHOD: TimoConfEntry[String] = stringConf("timo.partition.method", defaultValue = Some("STRPartitioner"))

  val PERIODTYPE: TimoConfEntry[String] =stringConf("timo.partition.period",defaultValue = Some("0"))

  var AGGERATOR_ORDER: TimoConfEntry[String] =stringConf("timo.aggerator.order",defaultValue = Some("1"))

  val AGGERATOR_ATTR: TimoConfEntry[String] =stringConf("timo.aggerator.attr",defaultValue = Some("0"))

  val RANGE_SEARCH: TimoConfEntry[String] =stringConf("timo.aggerator.range",defaultValue = Some("0"))

  val INTERVAL_SEARCH: TimoConfEntry[String] =stringConf("timo.aggerator.interval",defaultValue = Some("0"))

  val INDEX_ATTR_NUM: TimoConfEntry[Int] =intConf("timo.index.attrnum",defaultValue = Some(1))
