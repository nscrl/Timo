...
import org.apache.spark.sql.timo.{TemporalRDD, TimoSession}
...
private[timo] abstract class IndexedRelation extends LogicalPlan {
  ...
  var temporalRDD:TemporalRDD[Long]
  def timoSession: TimoSession = TimoSession.getActiveSession.orNull
